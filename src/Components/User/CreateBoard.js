            ...
            <div className='overlay'>
                <div className='modal-content !rounded-lg '>
                    ...
                    <form className=" px-4 py-4 mb-4 w-full">
                        <div className='mb-3'>
                            <input value={name} onChange={(e) => setName(e.target.value)} className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline  mt-2" name="name" type='text' placeholder='board name' />
                        </div>
                        ...
                        <div className='flex justify-end'>
                            ...
                            <select value={visibility} onChange={(e) => setVisibility(e.target.value)} className=' border outline-none text-sm shadow uppercase rounded-md px-2 '>
                                {role && role === 'manager' ? (
                                    <>
                        ...
                        <div className='text-center mt-3'>
                            <button onClick={handleSubmit} className=' bg-[#9C528B] text-white w-full rounded-lg m-2 py-1 text-center'>CREATE</button>
                        </div>
